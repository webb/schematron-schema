...
+count(svrl: red-rule) + count(svrl:failed-assert) +
        count(svrl:successful-report) = count(*)">
                <sch:name/> may only contain the following elements: text,
                ns-prefix-in-attribute-values, active-pattern,  red-rule, failed-assert and
        ...
        <sch:rule context="svrl: red-rule">
            <sch:extends rule="second-level"/>
            <sch:extends rule="empty"/>
            <sch:assert
                test="preceding-sibling::active-pattern |
            preceding-sibling::svrl: red-rule |
            preceding-sibling::svrl:failed-assert |
            preceding-sibling::svrl:successful-report"
                > A <sch:name/> comes after an active-pattern, an empty  red-rule,
        ...
        <sch:rule context="svrl:failed-assert | svrl:successful-report">
            ...
            <sch:assert
                test="preceding-sibling::svrl: red-rule |
            preceding-sibling::svrl:failed-assert |preceding-sibling::svrl:successful-
                report"
                > A <sch:name/> comes after a  red-rule, a failed-assert or a successful-
                report.
            </sch:assert>
        </sch:rule>
        <!-- Catch-all rule-->
